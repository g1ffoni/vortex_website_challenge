...
export type ListingSearchRequestStatus = typeof ListingSearchRequestStatus[keyof typeof ListingSearchRequestStatus];


export const ListingSearchRequestStatus = {
  ACTIVE: 'ACTIVE',
  CLAIMED: 'CLAIMED',
  COMPLETED: 'COMPLETED',
} as const;
