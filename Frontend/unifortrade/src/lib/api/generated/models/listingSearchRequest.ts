 ...
 */
import type { ListingSearchRequestStatus } from './listingSearchRequestStatus';
import type { ListingSearchRequestType } from './listingSearchRequestType';

export interface ListingSearchRequest {
  keyword?: string;
  categoryId?: number;
  ownerId?: number;
  type?: ListingSearchRequestType;
  status?: ListingSearchRequestStatus;
  minPrice?: number;
  maxPrice?: number;
}
