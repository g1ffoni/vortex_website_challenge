...
export type ListingSummaryResponseStatus = typeof ListingSummaryResponseStatus[keyof typeof ListingSummaryResponseStatus];


export const ListingSummaryResponseStatus = {
  ACTIVE: 'ACTIVE',
  CLAIMED: 'CLAIMED',
  COMPLETED: 'COMPLETED',
} as const;
